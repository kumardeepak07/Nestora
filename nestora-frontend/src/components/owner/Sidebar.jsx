...
const Sidebar = () => {
  ...
  return (
    ...
    md:max-w-60 w-full border-r border-borderColor text-sm'>
      ...
      {image && (
        <button onClick={updateImage} className='absolute top-0 right-0 flex p-2 gp-1 bg-primary/10 text-primary 
        cursor-pointer'>Save <img src={assets.check_icon} width={13} alt='' /></button>
      )}
