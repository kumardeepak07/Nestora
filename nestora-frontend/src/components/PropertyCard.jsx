...
const PropertyCard = ({property}) => {
  ...
  return (
    <div onClick={()=> {navigate(`/property-details/${property._id}`); scrollTo(0,0)}} className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1
    transition-all duration-500 cursor-pointer'>
      <div className='relative h-48 overflow-hidden'>
        ...
        <div className='absolute bottom-4 right-4 bg-black/80 backdrop-blur-sm ext-white px-3 py-2 rounded-lg'>
            <span className='font-semibold'>{currency}{property.pricePerDay}</span>
      ...
      <div className='p-4 sm:p-5'>
        ...
        <div className='mt-4 grid grid-cols-2 gap-y-2 text-gray-600'>
            ...
            <div className='flex items-center text-sm text-muted-foreground'>
                ...
                <span>{property.fuel_type} Seats</span>
            </div>
            <div className='flex items-center text-sm text-muted-foreground'>
                <img src={assets.car_icon} alt="" className='h-4 mr-2' />
                <span>{property.transmission} Seats</span>
            </div>
            <div className='flex items-center text-sm text-muted-foreground'>
                <img src={assets.location_icon} alt="" className='h-4 mr-2' />
                <span>{property.location} Seats</span>
            </div>
        </div>
