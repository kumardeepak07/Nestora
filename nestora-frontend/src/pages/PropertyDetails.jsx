...
const PropertyDetails = () => {
          ...
          <div className='lg:col-span-2'>
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                {[
                  {icon: assets.users_icon, text: `${property.seating_capacity} Seats`},
                  {icon: assets.fuel_icon, text: property.fuel_type},
              ...
              <div>
                ...
                <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                  {
                    ["360 Camera", "Bluetooth", "GPS Navigation", "Sunroof", "Leather Seats", "Heated Seats", "Backup Camera", "Remote Start"].map((item) => (
  ...
  ) : <Loader />; // Show loader while property data is being fetched
}
