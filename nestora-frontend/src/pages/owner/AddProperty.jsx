      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder='e.g. A luxurious Villa' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'  value={car.description} onChange={e => setCar({...car, description : e.target.value})}></textarea>
          </div>
